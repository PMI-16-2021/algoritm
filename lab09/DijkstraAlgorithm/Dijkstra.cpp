...
vertex_path dijkstra::get_shortest_path_to(const vertex& d)
{
	v_path.clear();
	v_path.push_front(d);
...
void dijkstra::set_edge_weight(const vertex& s, const vertex& d, double w)
{
...
void dijkstra::set_edge_weight(const edge& e, double w)
{
...
double dijkstra::get_edge_weight(const vertex& s, const vertex& d)
{
	if (e_weight.find(edge(s, d)) != e_weight.end())
	{
...
void dijkstra::relaxation(const vertex& s, const vertex& d)
{
...
void dijkstra::initialize(const vertex& s)
{
	v_distance.clear();
	v_queue.clear();
	v_previous.clear();
...
void dijkstra::shortest_paths_from(const vertex& s)
{
	initialize(s);
